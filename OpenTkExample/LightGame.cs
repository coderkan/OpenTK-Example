...
namespace OpenTkExample
{
    class LightGame : GameWindow
    {
        ...
        private void init()
        {
            ...
            int vertexShaderId = LoadShader(programId, "C:\\CrossPlatform\\OpenTkExample\\OpenTkExample\\vertex_shader.c", ShaderType.VertexShader);
            int fragmentShaderId = LoadShader(programId, "C:\\CrossPlatform\\OpenTkExample\\OpenTkExample\\fragment_shader.c", ShaderType.FragmentShader);
            // Link Program
            ...
            //GL.BindAttribLocation(programId, 0, "obje");

            attribute_vpos = GetAttribLocation("vPosition");
            attribute_vcol = GetAttribLocation("vNormal");
            uniform_mview = GetUniformLocation("modelview");
            int uniform_model = GetUniformLocation("model");
            int attribute_fragpos = GetAttribLocation("vColor");

            int objectColorLoc = GetAttribLocation("outColor");
            int zz = GetAttribLocation("ouput_color");
            int lightColorLoc = GL.GetUniformLocation(programId, "objectColor");
        ...
        private void initLight()
        {
            ...
            int vertexShaderId = LoadShader(programIdLight, "C:\\CrossPlatform\\OpenTkExample\\OpenTkExample\\light_vertex.c", ShaderType.VertexShader);
            int fragmentShaderId = LoadShader(programIdLight, "C:\\CrossPlatform\\OpenTkExample\\OpenTkExample\\light_fragment.c", ShaderType.FragmentShader);
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            int _c = GetAttribLocation("vPosition");
            ...
            int f = GL.GetAttribLocation(programId, "obje");
            ...
            //GL.UniformMatrix4
            //GL.Uniform4(modelLoc, lamp.ModelMatrix);
            GL.UniformMatrix4(modelLoc, false, ref lamp.ModelViewProjectionMatrix);
            GL.Uniform3(objectColorLoc, 0.0f, 1.0f, 1.0f);
            GL.Uniform3(lightColorLoc, 0.0f, 1.0f, 1.0f);
